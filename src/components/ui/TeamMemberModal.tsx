      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl max-h-[90vh] bg-gradient-to-br from-gray-900/95 via-black/90 to-gray-950/95 backdrop-blur-2xl border border-white/10 rounded-[32px] shadow-[0_50px_150px_-50px_rgba(0,0,0,0.8)] overflow-hidden"
